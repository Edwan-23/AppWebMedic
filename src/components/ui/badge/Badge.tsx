...
interface BadgeProps {
  variant?: BadgeVariant; // Claro o sólido
...
const Badge: React.FC<BadgeProps> = ({
  ...
  const sizeStyles = {
    sm: "text-theme-xs", // Padding y tamaño de fuente más pequeños
    md: "text-sm", // Padding y tamaño de fuente predeterminados
  };
  ...
  // Obtener estilos basados en el tamaño y la variante de color
