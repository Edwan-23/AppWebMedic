...
interface PhoneInputProps {
  ...
  selectPosition?: "start" | "end"; // Nuevo accesorio para la posición desplegable
}
...
const PhoneInput: React.FC<PhoneInputProps> = ({
  ...
  onChange,
  selectPosition = "start", // La posición predeterminada es 'start'
}) => {
